<template>
<div>
<v-card data-aos="fade-left" elevation="0"  class="overflow-y-auto" >
      <v-img max-height="700" src="https://stillmedab.olympic.org/media/Images/OlympicOrg/News/2019/05/27/Amsterdam-1928-football/2019-05-27-Amsterdam-1928-football-featured.jpg"></v-img>
...
<v-container style="overflow:hidden;" class="mt-16">
  ...
  <v-card data-aos="flip-up"
    ...
    <v-row>
      <v-col cols="12">
        <v-card height="40vh"  elevation="5">
